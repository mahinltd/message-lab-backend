        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
          ...
          <tr>
            <td style="background-color:#1a1a2e;padding:24px 40px;text-align:center;">
              <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:700;letter-spacing:0.5px;">MessageLab</h1>
          ...
          <tr>
            <td style="background-color:#f8f8fc;padding:24px 40px;text-align:center;border-top:1px solid #e8e8f0;">
              <p style="margin:0;color:#6b7280;font-size:12px;">
                You received this email because you have an account with MessageLab.
              </p>
              <p style="margin:8px 0 0;color:#9ca3af;font-size:11px;">
                &copy; ${new Date().getFullYear()} MessageLab. All rights reserved.
              </p>
              <p style="margin:8px 0 0;color:#9ca3af;font-size:11px;">
