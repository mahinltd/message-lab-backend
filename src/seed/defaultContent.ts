...
export async function seedDefaultContent(): Promise<void> {
  ...
  const defaultSettings = [
    ...
    },
    {
      ...
      value: 900000,
      valueType: "number",
      description: "Authentication failure window in milliseconds",
      category: "security",
    },
    {
      key: "auth_login_captcha_threshold",
      value: 3,
      valueType: "number",
      description: "Login failures before CAPTCHA is required",
      category: "security",
    },
    {
      key: "auth_login_lock_threshold",
      value: 10,
      valueType: "number",
      description: "Login failures from one IP before hard lock",
      category: "security",
    },
    {
      key: "auth_refresh_limit",
      value: 30,
      valueType: "number",
      description: "Refresh requests per IP per authentication window",
      category: "security",
    },
    {
      key: "auth_register_captcha_threshold",
      value: 2,
      valueType: "number",
      description: "Registration failures before CAPTCHA is required",
      category: "security",
    },
    {
      key: "auth_forgot_captcha_threshold",
      value: 2,
      valueType: "number",
      description: "Password reset failures before CAPTCHA is required",
      category: "security",
    },
    {
